...
const DEMAND = /보내주|보내줘|보내줄|보내달|부탁|도와주|빌려|빌릴|필요합니다|필요해요|필요한데|해주실|해주세요|가능할까|가능하신|대신 내|대신 결제|결제해|입금해|송금해|이체해|지불해/g;
...
const SIGNALS: Record<number, [string, RegExp][]> = {
  ...
  3: [
    ['비밀 유지 요구', /(비밀로|말하지 마|아무한테도|둘만의|우리만)/],
    ['대면·영상 회피', /(영상통화|화상|만나는 것)[^.!?]{0,15}(어렵|안 되|힘들|곤란)/],
