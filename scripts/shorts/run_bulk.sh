...
pub b_outfit.json  generic    yt_token2.json
pub b_loan.json    money      yt_token.json
pub b_music.json   generic    yt_token2.json
pub b_mindmap.json office     yt_token.json
pub b_travel.json  generic    yt_token2.json
pub b_retire.json  money      yt_token.json
pub b_wedding.json generic    yt_token2.json
echo "=========== BULK DONE ==========="
